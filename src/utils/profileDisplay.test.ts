...
describe('profileDisplay', () => {
  it('uses display name in the header first when set', () => {
    expect(
      getHeaderLabel({
        firstName: 'Jonathan',
        lastName: 'Allison',
  ...
  it('uses first name in the header when display name is absent', () => {
    expect(
      getHeaderLabel({
        firstName: 'Jonathan',
        lastName: 'Allison',
  ...
  it('uses the first word of full name when only names exist', () => {
    expect(
      getHeaderLabel({
        firstName: null,
        lastName: null,
